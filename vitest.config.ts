...
export default defineConfig({
  ...
  test: {
    ...
    environmentMatchGlobs: [
      ...
      ['specs/tests/activities_status.test.ts', 'node'],
      ...
      ['specs/tests/chat_messages.test.ts', 'node'],
      ['specs/tests/layout_css.test.ts', 'node'],
      ['specs/tests/events_authorization.test.ts', 'node'],
      ['specs/tests/tasks_authorization.test.ts', 'node'],
      ['specs/tests/albums_authorization.test.ts', 'node'],
    ],
  },
})
